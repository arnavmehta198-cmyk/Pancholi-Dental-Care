...
export const translations = {
  en: {
    ...
    'reviews.sparsh': 'Absolutely painless root canal — I was shocked how comfortable the whole procedure was.',
    'reviews.arnav': 'My hair transplant results look completely natural. Dr. Pancholi is a true expert.',
    'reviews.hilori': 'My smile makeover changed everything. I am so happy with the results!',
    'reviews.aanya': 'My new dentures fit perfectly and feel so natural. Highly recommend this clinic.',
    'reviews.helik': 'Quick, professional, and affordable. The crown feels just like my real tooth.',
    'reviews.sudhakar': 'Only ₹200 for a consultation and the care felt premium. Amazing value for Sagwara.',
    'reviews.mahendera': '19 years of experience really shows. Best clinic in Dungarpur, hands down.',
  ...
  hi: {
    ...
    'reviews.sparsh': 'बिल्कुल दर्द रहित रूट कैनाल — मैं हैरान था कि पूरी प्रक्रिया कितनी आरामदायक थी।',
    'reviews.arnav': 'मेरे हेयर ट्रांसप्लांट के नतीजे बिल्कुल प्राकृतिक लगते हैं। डॉ. पांचोली सच में विशेषज्ञ हैं।',
    'reviews.hilori': 'मेरे स्माइल मेकओवर ने सब कुछ बदल दिया। मैं नतीजों से बहुत खुश हूं!',
    'reviews.aanya': 'मेरे नए डेन्चर बिल्कुल फिट बैठते हैं और बहुत स्वाभाविक लगते हैं। इस क्लिनिक की पूरी सिफारिश करता हूं।',
    'reviews.helik': 'तेज़, पेशेवर और किफायती। क्राउन बिल्कुल मेरे असली दांत जैसा महसूस होता है।',
    'reviews.sudhakar': 'परामर्श के लिए केवल ₹200 और देखभाल प्रीमियम लगी। सागवाड़ा के लिए शानदार वैल्यू।',
    'reviews.mahendera': '19 साल का अनुभव वाकई दिखता है। डूंगरपुर का सबसे अच्छा क्लिनिक, बेशक।',
